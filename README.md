...
> A mobile web application that retrives latest price of popular cryptocurrencies from an API

**coinRate** displays a list of crypto coins form API!
...
```sh
  -cd my-folder
  -git clone git@github.com:mrsamsharma/coinRate.git
```
